...
CREATE TABLE "order_items" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "product_id" integer, "order_id" integer, "unit_price" decimal(12,3), "quantity" integer, "total_price" decimal(12,3), "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "message" text);
...
CREATE UNIQUE INDEX "index_categories_on_slug" ON categories ("slug" ASC);
CREATE UNIQUE INDEX "index_categories_on_slug_lower" ON categories ("slug_lower" ASC);
...
INSERT INTO schema_migrations (version) VALUES ('20151011130438');
